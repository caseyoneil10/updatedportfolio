	...
	<div id="about" className='w-full md:h-screen flex items-center py-16'>
		<div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
			...
			<h2 className="py-4">About Me</h2>
				...
				<p className="py-2 text-gray-600">I am thrilled at the prospect of new opportunities where I can help bring tools to life that makes solving problems easier!</p>
			</div>
